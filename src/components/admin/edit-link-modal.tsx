        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 mt-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="space-y-1.5">
              <Label htmlFor="edit-category" className="text-xs font-semibold text-slate-700 flex items-center justify-between">
                <span>Kategori</span>
            ...
            {/* Badge Select */}
            <div className="space-y-1.5">
              <Label htmlFor="edit-badge" className="text-xs font-semibold text-slate-700 flex items-center justify-between">
